...
import com.thirutricks.tllplayer.legacy.RenameDialogFragment
import com.thirutricks.tllplayer.legacy.ui.glass.GlassEffectUtils
import com.thirutricks.tllplayer.legacy.ui.glass.GlassStyleConfig
import com.thirutricks.tllplayer.legacy.ui.glass.GlassType
import com.thirutricks.tllplayer.legacy.ui.glass.MenuAnimationController
import com.thirutricks.tllplayer.legacy.ui.glass.TextLevel
import com.thirutricks.tllplayer.legacy.ui.glass.InteractiveFeedbackManager
import com.thirutricks.tllplayer.legacy.ui.glass.FeedbackType
import com.thirutricks.tllplayer.legacy.ui.glass.OperationType
...
//        view.alpha = 0.8F
    ...
    private fun showChannelOptions(position: Int, tvModel: TVModel) {
        ...
        optionsDialog.setChannelOptionsListener(object : ChannelOptionsDialogFragment.ChannelOptionsListener {
            ...
            override fun onFavouriteSelected() {
                ...
                com.thirutricks.tllplayer.legacy.models.TVList.refreshFavourites()
            ...
            override fun onDeleteSelected() {
                // Delete the channel
                com.thirutricks.tllplayer.legacy.models.TVList.removeChannel(tvModel.tv)
            ...
            override fun onRenameConfirmed(newName: String) {
                if (channelUrl.isNotEmpty()) {
                    ...
                    kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.Main).launch {
                        com.thirutricks.tllplayer.legacy.models.TVList.refreshModels()
                    }
                    // Update the adapter
                    update(tvListModel)
                }
    ...
    private fun moveChannelUp(position: Int) {
        ...
        if (index > 0 && index < currentOrder.size) {
            ...
            com.thirutricks.tllplayer.legacy.models.TVList.reassignChannelIds()
